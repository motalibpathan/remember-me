...
const Login = () => {
  ...
  return (
    <section class="bg-gray-50 dark:bg-gray-900 -mt-[65px]">
            ...
            >
              ...
              <div className="relative h-[30px] w-full">
                <button
                  ...
                  type="submit"
                  class={`${
                    left ? " translate-x-0 " : " translate-x-72 "
                  } duration-200 transform top-0 text-white bg-sky-600 hover:bg-sky-700 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800`}
                >
                  Sign in
                </button>
              </div>
